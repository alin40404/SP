<?php if (!defined('THINK_PATH')) exit();?><div id="assortmentSet1">
    ...
    <div>
       ...
       <div class="alert-info" style=" margin: 5px 3px; padding: 2px; text-align: center;">
        ...
        <table class="table table-hover table-condensed" style="font-size: small;">
            ...
            <tbody>
                <?php  foreach($data as $id=>$array){ $id=$array['aid']; $name=$array['aname']; ?>
                <tr>
                    <td>
...
<script type="text/javascript">
    	...
    	pageClickByData(".<?php echo ($pref); ?>_page", {key:"<?php echo ($search); ?>"}, "<?php echo ($replaceId); ?>", host + "g=<?php echo ($group); ?>&m=<?php echo ($module); ?>&a=showAll");
        ...
        singleBtn("<?php echo ($pref); ?>_btnAdd", "<?php echo ($pref); ?>_inputAdd", host + "g=<?php echo ($group); ?>&m=<?php echo ($module); ?>&a=addByName", {p : "<?php echo ($pgInfo['nowPage']); ?>"}, "<?php echo ($replaceId); ?>");
          //商品名称搜索
        singleBtn("<?php echo ($pref); ?>_btnSearch", "<?php echo ($pref); ?>_inputSearch", host + "g=<?php echo ($group); ?>&m=<?php echo ($module); ?>&a=showAll", {},  "<?php echo ($replaceId); ?>");
