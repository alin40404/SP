...
-->        
      ...
      <div class="content">
        ...
        <ul class="MM">
          <li><a href="<?php echo ($inforPartition); ?>" target="main">信息分类</a></li>
...
-->     
      ...
      <div class="content">
        ...
        <ul class="MM">
          <li><a href="<?php echo ($memberManage); ?>" target="main">会员管理</a></li>
          <li><a href="<?php echo ($manage); ?>" target="main">管理员管理</a></li>
