  ...
  <tr>
    <td width="182" valign="top"><div id="container">
      ...
      <div class="content">
        ...
        <ul class="MM">
         <li><a href="<?php echo ($rightUrl); ?>" target="main">后台首页</a></li>
          <li><a href="<?php echo ($clearCacheUrl); ?>" target="main">清除缓存</a></li>
          <li><a href="<?php echo ($baseSetUrl); ?>" target="main">基本设置</a></li>
         
<!--  
          <li><a href="<?php echo ($adSetUrl); ?>" target="main">广告设置</a></li>
          <li><a href="<?php echo ($linkManage); ?>" target="main">链接管理</a></li>

        
          <li><a href="http://www.baidu.com" target="main">邮件设置</a></li>
          <li><a href="http://www.google.com.hk/" target="main">广告设置</a></li>
          ...
          <li><a href="http://www.865171.cn" target="main">链接管理</a></li>
-->        
        </ul>
      </div>
      <h1 class="type"><a href="javascript:void(0)">菜篮子内容管理</a></h1>
      <div class="content">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><img src="__PUBLIC__/images/Admin/menu_topline.gif" width="182" height="5" /></td>
        ...
        <ul class="MM">
          <li><a href="<?php echo ($areaManage); ?>" target="main">地区管理</a></li>
           <li><a href="<?php echo ($marketTypeManage); ?>" target="main">市场类型管理</a></li>
          <li><a href="<?php echo ($marketManage); ?>" target="main">市场管理</a></li>
          <li><a href="<?php echo ($goodsManage); ?>" target="main">商品管理</a></li>
<!--          
...
-->     
      ...
      <div class="content">
        ...
        <ul class="MM">
          <li><a href="<?php echo ($memberManage); ?>" target="main">用户管理</a></li>
...
-->        
      ...
      <div class="content">
        ...
        <ul class="MM">
         <li><a href="<?php echo ($group); ?>" target="main">用户组管理</a></li>
          <li><a href="<?php echo ($role); ?>" target="main">角色管理</a></li>
         <li><a href="<?php echo ($adminUserManage); ?>" target="main">管理员管理</a></li>
        </ul>
      </div>
