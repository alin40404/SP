...
{
	var unit_id     = "2918777";
	var client_ip   = "121.14.89.163";
	var server_time = "1368526754";
	var verify_code = "a4f8eae6";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/2918777/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
